...
internal class Program
{
    ...
    private static Task<long> _currentTask;
    /// <summary>
    ...
    private static void CalculateSum(int n)
    {
        ...
        _currentTask = Task.Run(() => Calculator.Calculate(n, _cts.Token));

        _currentTask.ContinueWith(t => { Console.WriteLine($"Sum for {n} = {t.Result}."); });
        Console.WriteLine();
        Console.WriteLine("Enter N: ");
